...
while True:
    ...
    gmt_hour_vector = clock_hand_vector(gmt_hour/24*2*np.pi, hour_hand_length)
    ...
    plt.arrow(center[0], center[1], gmt_hour_vector[0], gmt_hour_vector[1], head_length = 2, linewidth = hour_hand_width, color = 'yellow')
